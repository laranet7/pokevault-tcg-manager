...
async def import_collection_item(
    ...
    pattern_variant: str | None = Form(None),
    ...
    try:
        ...
        payload = CollectionItemCreate(
            ...
            pattern_variant=_normalize_optional_text(pattern_variant),
...
async def create_manual_collection_item(
    ...
    try:
        ...
        payload = CollectionItemCreate(
            ...
            pattern_variant=pattern_variant.strip() or None if pattern_variant else None,
            is_for_sale=is_for_sale,
            base_price=base_price,
